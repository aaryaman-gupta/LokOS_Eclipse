...
public class allFnxsP {
	...
	public allFnxsP(xlsClasses xc, AndroidDriver<AndroidElement> appdriver, ExtentTest test, MobileTouchAdv mt, DeviceUtil du, int check[][]) {
	...
	public String selectById(ExtentTest test, String title, String dir, String loc, int row, int col, String id,
			boolean neg_test, boolean migr,String def,String a,String b, String c) {
		String entry="";
		String err = "p";
		if (neg_test) {
			try {
	...
	public String selectCustomById(ExtentTest test, String title, String dir, String loc, String xpath, int row,
			int col, String id, boolean neg_test, boolean migr,String def,String a,String b, String c) {
		String entry="";
		String err = "p";
		if (neg_test) {
			try {
	...
	public String selectFirstOptionById(String title, String dir, String loc, String xpath, boolean migr,String def,String a,String b, String c) {
		try {
	...
	public String dateLogic(ExtentTest test,String title, String dir, int row, int col,String loc, String id,String errid,boolean neg_test,String def,boolean migr) {
		try {
			System.out.println("Processing Details: " + title + "(id" + id + ")>>" + xc.getCellString(row, col));
			Thread.sleep(1500);
			String entry = xc.getCellString(row, col);
...
//			check[1][id]=1;
	...
	public boolean migrCheckById(ExtentTest test,boolean migr,String loc, String def) {
		try {
			if(!migr)
				return true;
	...
	public boolean migrCheckByXPath(ExtentTest test,boolean migr, String loc, String def) {
		try {
			if(!migr)
				return true;
			if (!def.equals("")) {
	...
	public boolean migrCheckByIdDD(ExtentTest test,boolean migr, String title,String def,String a,String b,String c) {
		try {
			if(!migr)
				return true;
	...
	public boolean migrCheckByXPathDD(ExtentTest test, boolean migr,String title, String def,String a,String b,String c) {
		try {
			if(!migr)
				return true;
			if (!def.equals("")) {
	...
	public boolean migrCheckRdBtn(ExtentTest test, boolean migr,String title, String def,String a,String b,String c,int btn_num) {
		try {
			if(!migr)
				return true;
			if (!def.equals("")) {
	...
	public String rdbtn(ExtentTest test, String title, String dir, int btn_num, int row, int col, String id,
			boolean neg_test, boolean migr,int def_btn_num,String a,String b, String c) {
		String entry="";
		String err = "p";
		if (neg_test) {
			try {
