...
public class navigationVO extends lokosTest {

	public static void voButton() throws InterruptedException {
		appdriver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		appdriver.findElementById("com.microware.cdfi:id/tbl_vo").click();
		Thread.sleep(2000);
	}

	public static void navToPanchayat(int row) throws InterruptedException {
		xc.changeSheet("VOs");
